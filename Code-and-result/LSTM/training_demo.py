...
from tensorflow.python.keras.layers import LSTM,Dropout,BatchNormalization
...
def model_training(data_dic,units1=128,units2=64,epochs=300,batch_size=100):
    ...
    model.add(LSTM(units=units1, input_shape=((x_train.shape[1],
                                                x_train.shape[2])),
    ...
    model.add(LSTM(units=units2,recurrent_activation = 'sigmoid'))
